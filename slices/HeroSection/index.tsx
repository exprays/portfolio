      ...
      <div className="grid min-h-[70vh] grid-cols-1 md:grid-cols-2 items-center">
        ...
        <div className="col-start-1 md:row-start-1">
            <h1 className="mb-8 text-[clamp(3rem,20vmin,20rem)] font-extrabold leading-none tracking-tighter" aria-label={slice.primary.first_name + " " + slice.primary.last_name}>
              ...
              <span className="-mt-[.2em] block text-zinc-600">
                {renderLetters(slice.primary.last_name, "last")}
              </span>
            </h1>
            <span className="tag-line block bg-gradient-to-tr from-yellow-500 via-yellow-200 to-yellow-500 bg-clip-text text-2xl font-bold uppercase tracking-[.2em] text-transparent opacity-0 md:text-4xl">
